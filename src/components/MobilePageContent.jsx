...
export default function MobilePageContent({ page, index, darkMode }) {
  if (page.type === "text") {
    return (
      <div className="flex h-full w-full flex-col items-center justify-around p-8 text-center">
        <img
  ...
  return (
    <img
      src={page.src}
      alt={`Page ${index + 1}`}
      className="h-full w-full select-none object-contain rounded-lg border-2 bg-white"
      draggable="false"
    />
  );
}
